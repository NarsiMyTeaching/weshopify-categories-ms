...
public class CategoryService {
	...
	public CategoryBean updateCategory(CategoryBean catBean) {
		...
		/**
		 * Prepare the Command and transport it to 
		 * the command handler by the command gateway 
		 */
		...
		if(future.isDone()) {
			log.info("is command delivered:\t"+future.isDone());
			return catBean;
			...
			log.info("is command delivered:\t"+future.isDone());
			throw new RuntimeException("command delivered exceptionally");
		}else {
